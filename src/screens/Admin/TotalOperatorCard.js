...
const TotalOperatorCard = ({ year }) => {
  ...
  return (
    <View style={styles.container}>
      <InfoCard
        color="#3a6a6e"
        title="Operator Wisata"
        value={data.operatorwisata|| 0}
      />
      <InfoCard
        color="rgba(251,200,83,255)"
        title="Operator Kuliner"
        value={data.operatorkuliner || 0}
      />
      <InfoCard
        color="rgba(236,111,55,255)"
        title="Operator Akomodasi"
        value={
          data.operatorakomodasi || 0
        }
      />
    </View>
  );
  ...
  const styles = StyleSheet.create({
    ...
    title: {
      fontSize: 8, // Ukuran font judul dapat disesuaikan dengan ukuran layar
      fontWeight: 'bold',
      color: '#333',
    },
    value: {
